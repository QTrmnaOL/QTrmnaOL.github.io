# Autotrimps v2 alpha QTrmnaOL
Original Autotrimpsv2: https://github.com/genbtc/AutoTrimps-betadev
## Trying to add some sort of push notification feature for completed challenges and / or zones.
## Trying to add some sort of feature to remotly configure autotrimps - by fetching data from Google Sheets or something else.
...
```js
javascript:with(document)(head.appendChild(createElement('script')).src='https://github.com/QTrmnaOL/Autotrimps-v2-alpha-QTrmnaOLAutoTrimps2.js')._
```
